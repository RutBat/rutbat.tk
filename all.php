...
<li class="list-group-item d-flex justify-content-between align-items-center" style="padding: 0rem 0rem;">

    <!--Тут я поставил отступ 15 px-->
    ...
    <div class="pagination">
        ...
        <a href="<?php if ($pageno <= 1) {
                    ...
                    } ?>" type="button" class="col-md-4 col-sm-4  col-4 mx-auto btn btn-warning-left 
                 <?php if ($pageno <= 1) {
                        echo 'disabled';
        ...
        <div class="auto col-md-1 col-sm-1  col-1 mx-auto btn btn-warning disabled"
            style="border-color:#000;border-radius: 0rem;background-color: #fbfbfb;">
