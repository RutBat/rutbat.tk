				...
				<form method="GET" action="/adddom.php">
					<li  class="list-group-item  justify-content-between align-items-center">
						<div class="input-group mb-3">
							<small  class="form-text text-muted">Добавляет ШАБЛОН дома. Просто адрес в который потом добавляется информация (по мере поступления онной)
							</small>
							...
							echo '</div><small  class="text-danger form-text">Регион</small><select name="region" class="custom-select mr-sm-2">';
