...
?>
    ...
    <body text="#000000" vlink="#00007f" alink="#ff0000" link="#0000ff" bgcolor="#ffffff" onload="err_text()">
        <blockquote>
            <br>
            <br>
            <h2>Ошибка <span style="color: red;">4</span><span style="color: blue;">0</span><span
                    style="color: red;">4</span>: страница не найдена.</h2>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <form><textarea rows="8" cols="60"
                    style="border:none;overflow: hidden;background: #e9ecef00; font-family: 'Lobster', cursive; font-size: 1.2rem; width:100%"></textarea>
            </form>
            <br><br><br><br>
        </blockquote>
